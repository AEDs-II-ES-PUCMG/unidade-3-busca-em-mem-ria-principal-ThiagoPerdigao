public class Cliente {
     ...
     * TODO: utilize obrigatoriamente o método setNome para atribuir o nome ao cliente. OK
	...
	public void setNome(String nome) {
        if (nome == null || nome.trim().split("\\s").length <2 )
            throw new IllegalArgumentException("Nome deve ter pelo menos duas palabras");
		this.nome = nome.trim();
	}
