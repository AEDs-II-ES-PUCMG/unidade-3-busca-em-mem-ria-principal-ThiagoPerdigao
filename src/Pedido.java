...
public class Pedido implements Comparable<Pedido> {
	 ...
	 *  TODO: armazene também o cliente que realizou o pedido. OK
	 */
	...
	public String toString() {
		...
		// TODO: implementar (adicione uma linha com o cliente do pedido, no formato "Cliente do pedido: <cliente>") OK
		if (cliente != null)
