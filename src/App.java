...
public class App {
    ...
    */
    static int menu() {
        ...
        System.out.println("9 - Gravar, em arquivo, pedidos de um cliente");
        System.out.println("10 - Listar pedidos de um cliente");
        // - uma opção para exibir o histórico completo de pedidos de um cliente ok
    ...
    static AVL<Integer, Cliente> lerClientes(String nomeArquivoDados) {
        ...
        try (Scanner arquivo = new Scanner(new File(nomeArquivoDados), Charset.forName("UTF-8"))) {
            ...
            for (int i = 0; i < numClientes; i++) {
                Cliente cliente = new Cliente(arquivo.nextLine());
    ...
    private static Lista<Pedido> gerarPedidos(int quantidade) {
        ...
        for (int i = 0; i < quantidade; i++) {
        	...
        	// TODO: selecione aleatoriamente um cliente para este pedido. OK
        	...
        	int idCliente = sorteio.nextInt(quantosClientes) + 10_000;
            ...
            // TODO: vincule o cliente sorteado ao seu novo pedido na tabela hash pedidosPorCliente, OK
    ...
    private static void inserirNaTabelaPedidosDoCliente(Cliente cliente, Pedido pedido) {
    	...
    	// TODO: implementar, de forma análoga ao método inserirNaTabela(Produto, Pedido): OK
    ...
    public static void pedidosDoCliente() {
        ...
        try {
            ...
            System.out.println("Cliente nao encontrado ou sem historico de pedidos.");
        }
    ...
    public static void rankingClientes() {
        ...
        Lista<Cliente> cliente = clientesPorId.recortar(idDeOnde, idAteOnde);
